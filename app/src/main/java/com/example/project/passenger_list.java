...
public class passenger_list extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listview = findViewById(R.id.list_passenger);
        ...
        refrence.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (Map.Entry<String, Object> entry : users.entrySet()){
                    ...
                    if(singleUser.get("role").toString().equals("0")||singleUser.get("role").toString().equals("2")){
                        Toast.makeText(passenger_list.this,singleUser.get("role").toString(),Toast.LENGTH_LONG).show();
                        Log.v("inner", "piyush");
